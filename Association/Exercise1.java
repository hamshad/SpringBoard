class CabServiceProvider {
  ...
  public double calculateRewardPrice(Driver driver) {
    ...
    if (averageRating >= 4 && averageRating < 4.5) {
      rating = cabServiceName.equals("Halo") ? driver.getAverageRating() * 5 : driver.getAverageRating() * 3;
    }
    if (averageRating >= 4.5 && averageRating <= 5) {
      rating = cabServiceName.equals("Halo") ? driver.getAverageRating() * 10 : driver.getAverageRating() * 8;
    }
